...
SOPCINFO_FILE := C:/Users/anton/Desktop/CEFET201/DispReprog/aula2910/aula2910_qsys.sopcinfo
...
# CPU Name 
# setting CPU_NAME is nios2_qsys_avsb
CPU_NAME = nios2_qsys_avsb
...
# Design Name 
# setting SOPC_NAME is aula2910_qsys
SOPC_NAME := aula2910_qsys
...
# setting hal.stderr is jtag_uart_avsb
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_avsb

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_avsb
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_avsb
...
# setting hal.stdout is jtag_uart_avsb
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_avsb
